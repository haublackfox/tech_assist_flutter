...
import 'package:tech_assist_flutter_next/screens/worker_signup_page.dart';
import 'package:tech_assist_flutter_next/widgets/snackbar.dart';

class WorkerSignInPage extends StatefulWidget {
  @override
  _WorkerSignInPageState createState() => _WorkerSignInPageState();
}
    ...
    Widget _buildSignupBtn() {
      return GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => WorkerSignUpPage()),
          );
        },
        child: RichText(
          text: TextSpan(
